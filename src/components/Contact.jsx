  ...
  return (
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden justify-center items-center">
      <motion.div
        ...
        className="flex-[0.75] bg-black-100 rounded-2xl self-center"
      >
    ...
    //   > */}
        ...
        <h2 className={`${styles.sectionHeadText} text-center`}> Contacts </h2>
        ...
        >
          <label className="flex flex-col">
            ...
            <input
              ...
              className="bg-teritary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium"
            />
          </label>
          <label className="flex flex-col">
